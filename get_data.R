...
wdnor <- ApiData(07995, ContentsCode = "Dode1", Kjonn = 2:3, Alder = 1:104, 
  ...
  mutate(deaths = ifelse(year == 2020 & week == update_week - 2, deaths / 0.75, deaths),
         deaths = ifelse(year == 2020 & week == update_week - 3, deaths / 0.92, deaths),
...
download.file(urlswe, tmp, mode = "wb")
